...
_Last updated: March 2025 — Chirpy Red membership; Polka webhooks with API key verification; `POST /api/polka/webhooks`; `isChirpyRed` in user responses; DELETE /api/chirps/:chirpId (only chirp author may delete; 404/403/204 responses)._
